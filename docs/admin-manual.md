...
> **Scope:** this document is about the **web app admin UI** only. For the API-level way to onboard a kit (tokens, `POST /api/kits`, file keys), see [`kit-onboarding.md`](https://github.com/PazhenkovaEA/STReamGT/blob/nf-pipeline-review/docs/kit-onboarding.md). For infrastructure, deployment, and AWS operations, see [`aws-setup.md`](https://github.com/PazhenkovaEA/STReamGT/blob/nf-pipeline-review/docs/aws-setup.md) and [`deployment.md`](https://github.com/PazhenkovaEA/STReamGT/blob/nf-pipeline-review/docs/deployment.md).
...
- [`kit-onboarding.md`](https://github.com/PazhenkovaEA/STReamGT/blob/nf-pipeline-review/docs/kit-onboarding.md) — registering a kit via the API instead of the UI.
- [`architecture.md`](https://github.com/PazhenkovaEA/STReamGT/blob/nf-pipeline-review/docs/architecture.md) — how the platform is put together.
- [`aws-setup.md`](https://github.com/PazhenkovaEA/STReamGT/blob/nf-pipeline-review/docs/aws-setup.md), [`deployment.md`](https://github.com/PazhenkovaEA/STReamGT/blob/nf-pipeline-review/docs/deployment.md) — infrastructure & ops.
